...
public final class DefaultEditableAttributesHolder implements
    ...
    public DefaultEditableAttributesHolder() {
        super();
    ...
    public DefaultEditableAttributesHolder(
            final DefaultEditableAttributesHolder attributes) {
        super();
    ...
    @Override
    public final DefaultEditableAttributesHolder createNewInstance() {
        return new DefaultEditableAttributesHolder(this);
    }
